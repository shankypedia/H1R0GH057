...
headers_useragents=[]                                                                             #EDITED BY LOW WALKER#
...
headers_referers.append('Google.com')
...
def usage():
	print 'SadAttack Version 2.1 DDoS Tool Created By Hax Stroke~Edited by low walker '
...
"""                                                       
  ...
  ###########        ##   ##      ######
..  
~~~Script criada por Hax Stroke~~~
EDITADA POR LOW WALKER
HACKING DROID
~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			...
 			print '#~~~~~~~~~~~~~~~~~~~~~~~~~#'
 			print '[+]~~~Packs uploaded~~~~[+]'
 			print '[+]~~~Packets lauched~~~[+]'
 			print '#~~~~~~~~~~~~~~~~~~~~~~~~~#'                                                                
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Ferramenta DDoS website editada por Low walker"
